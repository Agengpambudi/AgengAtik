 ...
 * @author T
 */
public class Admin_Simpanan_Tambah extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Simpanan_Tambah
     */
    public Admin_Simpanan_Tambah() {
        initComponents();
    }
...
new Admin_Pinjaman ().setVisible (true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Simpanan_Tambah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
