 ...
 * @author T
 */
public class Ketua_Pinjaman extends javax.swing.JFrame {

    /**
     * Creates new form Ketua_Pinjaman
     */
    public Ketua_Pinjaman() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tanggal", "No Pinjaman", "ID Anggota", "Nominal", "Status"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 120, -1, 240));
...
new login ().setVisible (true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ketua_Pinjaman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
