 ...
 * @author T
 */
public class Admin_Beranda extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Beranda
     */
    public Admin_Beranda() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 10, -1, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 100, 40));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 220, 100, 40));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, 100, 40));
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cobagui/PBO Layout FIX 2.png"))); // NOI18N
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -6, 600, 410));
...
new Admin_Angsuran ().setVisible (true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Beranda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
