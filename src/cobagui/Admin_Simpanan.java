 ...
 * @author T
 */
public class Admin_Simpanan extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Simpanan
     */
    public Admin_Simpanan() {
        initComponents();
    }
...
new Admin_Angsuran ().setVisible (true);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
      this.dispose ();
new Admin_Simpanan_Tambah ().setVisible (true);
...
new login ().setVisible (true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Simpanan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
